...
enum
{
    ...
    STORAGE_LAYOUT_SETTINGS_BYTES = STORAGE_LAYOUT_W25Q_SECTOR_SIZE,
    STORAGE_LAYOUT_DIAGNOSTICS_BYTES = 4u * STORAGE_LAYOUT_W25Q_SECTOR_SIZE,
