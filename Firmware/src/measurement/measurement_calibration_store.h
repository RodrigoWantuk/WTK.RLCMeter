...
typedef enum
{
    ...
    MEASUREMENT_CAL_STORE_ERASE,
    MEASUREMENT_CAL_STORE_PROGRAM_HEADER,
...
typedef struct
{
    ...
    bsp_status_t (*erase_sector)(uint32_t address, void *user);
    bsp_status_t (*program)(uint32_t address, const void *src, size_t size, void *user);
    bsp_status_t (*poll)(void *user);
    void *user;
