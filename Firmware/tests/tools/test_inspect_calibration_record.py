...
def valid_frame():
    ...
    put_u16(frame, 20, inspect_cal.MODEL_OSL_MOBIUS_EFFECTIVE_HG_V1)
    ...
    struct.pack_into("<IHBBBBiII", frame, rec, 0x00010001, inspect_cal.MODEL_OSL_MOBIUS_EFFECTIVE_HG_V1,
